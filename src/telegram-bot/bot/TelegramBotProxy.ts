import TelegramBot, { ChatId, SendMessageOptions, Message, ConstructorOptions } from "node-telegram-bot-api";
...
export default class TelegramBotProxy extends TelegramBot {
    ...
    sendMessage(chatId: ChatId, text: string, options?: SendMessageOptions): Promise<Message> {
