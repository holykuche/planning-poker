...
export default function (dependencies: Dependencies, args: any[], target: Object, propertyKey: string): Promise<number> {
    ...
    if (typeof lobbyIdParameterIndex === "number") {
        ...
        return Promise.reject(new Error("Can't resolve lobbyId. You should mark lobbyId or memberId in parameters."));
    }
}
