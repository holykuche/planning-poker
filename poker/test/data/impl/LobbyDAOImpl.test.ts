...
describe('data/impl/LobbyDAOImpl', () => {
  ...
  it('save should send save query to db', () => {
    ...
    return lobbyDAO.save(lobby).then(returnedLobby => {
  ...
  it('getById should send find query to db', () => {
    ...
    return lobbyDAO.getById(lobby.id).then(returnedLobby => {
  ...
  it('getByName should send find query to db', () => {
    ...
    return lobbyDAO.getByName(lobby.name).then(returnedLobby => {
  ...
  it('deleteById should send delete query to db', () => {
    ...
    return lobbyDAO.deleteById(lobbyId).then(() => {
  ...
  it('isExists should send find query to db', async () => {
    ...
    return lobbyDAO.isExists(lobby.name).then(isExists => {
      expect(dbClientMock.find).toBeCalledWith(
        TableName.Lobby,
        'name',
        lobby.name
