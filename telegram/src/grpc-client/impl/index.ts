...
import { GRPC_CLIENT_TYPES, DatabaseClient, LobbyClient, MemberClient } from "../api";
...
container.bind<MemberClient>(GRPC_CLIENT_TYPES.MemberClient).to(MemberClientImpl);
